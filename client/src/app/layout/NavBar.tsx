...
import { Box, Toolbar, Typography, AppBar, Button, Container, MenuItem } from "@mui/material";
               ...
               <Box sx={{display: "flex"}}>
                 <MenuItem sx={{fontsize: '1.2rem', textTransform: 'uppercase', fontWeight: 'bold'}}> Activities </MenuItem>
                  <MenuItem sx={{fontsize: '1.2rem', textTransform: 'uppercase', fontWeight: 'bold'}}> About </MenuItem>
                   <MenuItem sx={{fontsize: '1.2rem', textTransform: 'uppercase', fontWeight: 'bold'}}> Contaxt </MenuItem>
               </Box>
